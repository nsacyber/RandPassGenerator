...
public class WordSet {
     ...
     * </ol>
     *
     * This is a little bit wasteful of DRBG output bits, in the sense that
     * on average it will consume ~64.000001 bits of random where it 
     * really only needs log2(M) bits.   (M usually about 64K, so about
     * 16-17 bits).  [There is an optimal method I could have used, called
